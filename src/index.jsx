...
export default class SuperSelect extends PureComponent {
                 constructor(props) {
                   ...
                   // 可视区 dom 高度
                   this.visibleDomHeight =
                     this.ITEM_HEIGHT * ITEM_ELEMENT_NUMBER;
                 ...
                 scrollToValue = () => {
                   ...
                   const index =
                     children.findIndex(item => item.key === value) || 0;
                 ...
                 addEvent = () => {
                   this.scrollEle = document.querySelector(
                   ...
                   setTimeout(() => {
                     ...
                     if (offsetTop - this.prevTop > DROPDOWN_HEIGHT && isUp) {
                       this.scrollEle.scrollTo(
                         0,
                         this.allHeight - DROPDOWN_HEIGHT
                       );
                     ...
                     if (
                       ...
                       this.scrollEle.scrollTo(
                         0,
                         this.scrollTop + this.ITEM_HEIGHT
                       );
                       return;
                     }
                 ...
                 onScrollReal = () => {
                   ...
                   // 重新渲染列表组件 Wrap
                   const allHeight =
                     this.allList.length * this.ITEM_HEIGHT || 100;
                 ...
                 // 列表可展示所有 children
                 getUseChildrenList = () =>
                   this.state.filterChildren || this.state.children;
                 ...
                 removeEvent = () => {
                   ...
                   if (!this.inputEle) return;
                   this.inputEle.removeEventListener(
                     'keydown',
                     this.onKeyDown,
                     false
                   );
